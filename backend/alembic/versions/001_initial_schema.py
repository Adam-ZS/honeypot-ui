...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('role', postgresql.ENUM('viewer', 'analyst', 'admin', name='userrole', create_type=False), nullable=False, server_default='analyst'),
    ...
    op.create_table(
        ...
        sa.Column('mode', postgresql.ENUM('active', 'passive', name='honeypotmode', create_type=False), nullable=False, server_default='active'),
        sa.Column('is_active', sa.Boolean(), nullable=True, server_default='true'),
    ...
    op.create_table(
        ...
        sa.Column('status', postgresql.ENUM('active', 'completed', 'terminated', name='sessionstatus', create_type=False), nullable=False, server_default='active'),
        sa.Column('started_at', sa.DateTime(timezone=True), nullable=False),
        sa.Column('ended_at', sa.DateTime(timezone=True), nullable=True),
        sa.Column('duration_seconds', sa.Float(), nullable=True),
        sa.Column('attack_category', postgresql.ENUM('benign', 'reconnaissance', 'exploitation', 'exfiltration', name='attackcategory', create_type=False), nullable=True),
        sa.Column('attack_confidence', sa.Float(), nullable=True),
        sa.Column('attacker_profile', postgresql.ENUM('script_kiddie', 'automated_bot', 'skilled_attacker', 'apt', 'unknown', name='attackerprofile', create_type=False), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
        sa.Column('session_id', sa.Integer(), nullable=False),
        sa.Column('severity', postgresql.ENUM('low', 'medium', 'high', 'critical', name='attackseverity', create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('min_severity', postgresql.ENUM('low', 'medium', 'high', 'critical', name='attackseverity', create_type=False), nullable=True, server_default='medium'),
